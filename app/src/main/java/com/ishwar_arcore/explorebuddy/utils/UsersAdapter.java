...
import com.ishwar_arcore.explorebuddy.databinding.UserItemBinding;
import com.ishwar_arcore.explorebuddy.views.activities.chat.ChatActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersViewHolder> {
    ...
    Context context;
    ArrayList<Traveller> users;

    public UsersAdapter(Context context, ArrayList<Traveller> users) {
    ...
    public void onBindViewHolder(@NonNull UsersViewHolder holder, int position) {
        Traveller user = users.get(position);
